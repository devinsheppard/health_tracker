(function initCatalog(root, factory) {
  ...
  const exerciseGroups = {
    ...
    Shoulders: [['Lateral raises', 'single'], ['Front raises', 'single'], ['Overhead press', 'bilateral'], ['Arnold press', 'bilateral'], ['Rear delt fly', 'single'], ['Rear Delt Cable Fly', 'single'], ['High and Wide Face Pulls', 'bilateral'], ['Cable lateral raise', 'single'], ['Arm-Wrestling Inward Pivot', 'single'], ['Upright row', 'bilateral']],
