(function initCatalog(root, factory) {
  ...
  const exerciseGroups = {
    ...
    Biceps: [['Curls pronated', 'single'], ['Curls supinated', 'single'], ['Hammer curls', 'single'], ['Barbell curls', 'bilateral'], ['Cable Kong Curl', 'bilateral'], ['Concentration curls', 'single'], ['Cable curls', 'single'], ['Preacher curls', 'single']],
